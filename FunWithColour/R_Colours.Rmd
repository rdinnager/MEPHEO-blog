...
Here is an example of using Jo-fai's function using one of my favourite images of one of my favourite animals, which I will use throughout this post:
...
``````{r examples 2, cache=TRUE, message=FALSE, warning=FALSE}
...
```{r find colours, eval=FALSE, cache=TRUE, message=FALSE, warning=FALSE}
library(picante)
